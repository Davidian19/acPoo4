...
public class Conta extends Identificavel {
	...
	public double calcularPrecoTotal(int quantidade) {
		return calcularPrecoTotal(quantidade, 0.00);				
	}
	 
	public double calcularPrecoTotal(int quantidade, double percDesconto) {
		return (1 - percDesconto/100)*preco*quantidade;				
	}
	*/
}
