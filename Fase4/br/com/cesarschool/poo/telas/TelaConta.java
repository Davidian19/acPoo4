...
public class TelaConta {
	...
	private static final String DIGITE_O_NUMERO = "Digite numero: ";
	...
	private long processaBusca() {
		...
		if (conta == null) {
			...
			if (conta instanceof ContaPoupanca) {
				...
				System.out.println("Qtd depositos: " + contaPoupanca.getQtdDepositos());
			}
			return numero;
		}
	}
	...
	private void processaBloquear(long numero) {
		processaMudancaStatus(numero, OPC_BLOQUEIO, "Conta bloqueada com sucesso!", "Bloqueio nao processado!"); 
	}
	private void processaEncerrar(long numero) {
		processaMudancaStatus(numero, OPC_ENCERRAMENTO, "Conta encerrada com sucesso!", "Encerramento nao processado!"); 
	}
	private void processaDesbloquear(long numero) {
		processaMudancaStatus(numero, OPC_DESBLOQUEIO, "Conta desbloqueada com sucesso!", "Desbloqueio nao processado!"); 
	}
	...
	private Conta capturaConta(long numeroDaAlteracao) {
		...
		System.out.print("Digite <1> para conta normal e <2> para conta poupanca: ");
